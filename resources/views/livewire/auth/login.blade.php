<div>
    <div class="min-h-screen ">
        <x-card>
            ...
            <!-- Session Status -->
            <div class="block w-full py-4 text-center">
            ...
            <form wire:submit="authenticate" class="w-full">
                ...
                <div class="grid lg:grid-cols-2 sm:grid-cols-1 gap-4 text-left">
                    ...
                    <div>
                        ...
                        <x-text-input id="email" class="block mt-1 w-full" wire:model="email" type="email"
                ...
                <div class="flex items-center justify-between mt-4">
                    ...
                    @if (Route::has('password.request'))
                        <a class="underline text-sm text-gray-600 hover:text-gray-900 dark:text-gray-100 dark:hover:text-gray-800"
                ...
                <div class="flex items-center justify-between mt-4 ">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox" wire:model="remember_me"
                            ...
                            name="remember">
                        <span class="ml-2 text-sm text-gray-600 dark:text-gray-100">Se souvenir de la connexion</span>
                    </label>
