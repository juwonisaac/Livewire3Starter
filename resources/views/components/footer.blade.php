<footer
    class="w-full mt-auto bg-gray-100 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.03] dark:to-transparent">
    <div class="px-6">
        <div class="grid gap-y-10 gap-x-4 py-14 sm:grid-cols-3 lg:grid-cols-3 lg:py-[100px]">
            <div class="relative">
                <img src="" loading="lazy" alt="Livewire3Starter" class="h-7">
                <ul class="my-6 flex flex-col gap-3 font-bold">
                    <li class="mb-3 text-lg font-extrabold text-black dark:text-white">{{ __('Information & Contact') }}
                    </li>
                    <li>
            ...
            <div>
                <ul class="flex flex-col gap-3 font-bold">
                    ...
                    @php($pages = \App\Models\Page::query()->take(3)->get())
    ...
    <div class="bg-blue-800 text-white py-5 border-t-2 border-gray-300">
        <div class="px-6">
            <div class="flex flex-col items-center justify-between text-center font-bold dark:text-white md:flex-row">
                ...
                <div>
                    ...
                    <a href="/contact" wire:navigate class="text-indigo-200 underline hover:text-indigo-800">
                        Contactez-nous    
                    </a>
                </div>
            </div>
