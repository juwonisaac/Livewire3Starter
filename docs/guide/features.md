...
| --- | --- | --- | --- |
| Contact/Index | in progress | 😐 | mount, render, showModal(Contact $contact), delete($id) |
| Admin/Dashboard | in progress | 😐 | render: View |
| Pages/Create | in progress | 😐 | saveEditorState($editorJsonData), addCardContent: void, addNestedCardContent($index): void, saveCardContent: void, removeCardContent($index): void, removeNestedCardContent($parentIndex, $nestedIndex): void, save, render: View |
| Pages/Edit | in progress | 😐 | saveEditorState($editorJsonData), addCardContent, addNestedCardContent($index): void, saveCardContent: void, removeCardContent($index): void, removeNestedCardContent($parentIndex, $nestedIndex): void, mount($slug), update, render: View |
| Pages/Index | in progress | 😐 | mount, delete($id): void, render: View |
| Section/Create | in progress | 😐 | pages, render: View|Factory, createModal, create |
| Section/Edit | in progress | 😐 | pages, editModal($id), update, render: View |
| Section/Index | in progress | 😐 | refreshIndex, mount, render, setFeatured($id), showModal(Section $section), delete($id) |
| Admin/UserTable | in progress | 😐 | mount, delete($id), showTab($id, $type), closeTab, render |
| Auth/Index | in progress | 😐 | hideLoginForm, render |
...
| Auth/Register | in progress | 😐 | mount, store, render |
...
| Livewire/ContactForm | in progress | 😐 | render, submit |
| Livewire/DynamicPages | in progress | 😐 | mount($slug), render |
| Livewire/EditorJs | in progress | 😐 | mount(, completedImageUpload(string $uploadedFileName, string $eventName, $fileName = null), loadImageFromUrl(string $url), save, render |
| Forms/PageForm | in progress | 😐 | setPage(Page $page), store, update |
| Forms/SectionForm | in progress | 😐 | setPost(Section $section), store, update |
| Livewire/FrontIndex | in progress | 😐 | sections, render |
| --- | --- | --- | --- |
